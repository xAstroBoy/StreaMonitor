...
def create_registry_entry():
    key_path = r"Directory\Background\shell\SubDeleter"
    command = r'cmd.exe /c cd /d "%V" && python "C:\AstroTools\SubDeleter.py" "%V"'
    ...
    try:
        ...
        winreg.SetValue(key, None, winreg.REG_SZ, "Delete Unwanted Files by Extensions")
