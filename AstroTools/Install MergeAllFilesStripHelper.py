...
def create_registry_entry():
    key_path = r"Directory\Background\shell\MergeAllFiles"
    command = r'cmd.exe /c python "C:\AstroTools\run_striphelper.py" "%V"'
    ...
    try:
        ...
        winreg.SetValue(key, None, winreg.REG_SZ, "Merge all StreaMonitor Files in folders")
