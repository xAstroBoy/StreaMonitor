...
// Embedded RGBA pixel data for window icon (generated by generate_icon.py)
        ...
        while (!glfwWindowShouldClose(window_))
        {
            try
            {
                ...
                catch (const std::exception &e)
                {
                    ...
                    // ImGui command buffer is in an inconsistent state (mismatched
                    // Begin/End, imbalanced style pushes, etc.) — EndFrame() resets
                    // internal state without attempting to render the corrupt data.
                    ImGui::EndFrame();
                    continue;
                }
                catch (...)
